...
<?php
include "./assets/components/head.phtml" ?>

<body>
<div class="masthead clearfix">
    <?php
    include "./assets/components/nav.phtml" ?>
</div>
        ...
        <div class="cover-container">
            ...
            <div id="home" class="inner cover">
                ...
                <ul style="text-align: left">
                    ...
                    <li>EHBO AANWEZIG</li>
                    <li>PARCOURS AAN DE OOSTERBOEKELWEG</li>
                    <li>DOUCHE VAN DE BRANDWEER</li>
                </ul>
                </p>
...
<div class="mastfoot">
    <div class="inner">
        <?php
        include "./assets/components/foot.html" ?>
    </div>
</div>
