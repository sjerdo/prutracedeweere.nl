    ...
    <div class="site-wrapper-inner">
      ...
      <div class="cover-container">
        ...
        <div id="inschrijven" class="inner cover">
          ...
          <p class="lead">
            <button type="button" id="inschrijfBtn" class="btn btn-lg btn-default" onclick="window.location='https://totaltiming.inschrijven.nl/form/2023070851424-nl';" disabled> Schijf mij maar in! </button>
          </p>
