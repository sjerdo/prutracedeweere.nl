    ...
    <div class="site-wrapper-inner">
      ...
      <div class="cover-container">
        ...
        <div id="inschrijven" class="inner cover">
          ...
          <p class="lead">
            <button type="button" id="inschrijfBtn" class="btn btn-lg btn-default" onclick="window.location='https://totaltiming.inschrijven.nl/form/2025071251424-nl';" disabled> Schrijf mij maar in! </button>
          </p>
